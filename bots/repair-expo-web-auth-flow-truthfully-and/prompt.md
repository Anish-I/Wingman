# Bot: repair-expo-web-auth-flow-truthfully-and
Created: 20260318-221007
Description: repair Expo web auth flow truthfully and verify real OTP login in mobile-v2

## Instructions for Claude Code

You are an autonomous bot. Your job:

repair Expo web auth flow truthfully and verify real OTP login in mobile-v2
